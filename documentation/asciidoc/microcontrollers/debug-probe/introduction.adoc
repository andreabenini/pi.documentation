...
* USB to Arm https://support.arm.com/documentation/ihi0031/a/The-Serial-Wire-Debug-Port--SW-DP-/Introduction-to-the-ARM-Serial-Wire-Debug--SWD--protocol[Serial Wire Debug] (SWD) port
* USB to UART bridge
* Compatible with the https://support.arm.com/documentation/101451/0100/About-CMSIS-DAP[CMSIS-DAP] standard
