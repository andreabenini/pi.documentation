...
+
--
image::images/vnc-tigervnc-enter-ip.png[alt="Entering the Raspberry Pi device's local IP address into TigerVNC",width="60%"]
--
...
+
--
image::images/vnc-tigervnc-username-password.png[alt="Entering a username and password to authenticate through TigerVNC",width="60%"]
--
