...
The Linux kernel is highly configurable. Advanced users might want to modify the default configuration to customise it to their needs, such as enabling a new or experimental network protocol, or enabling support for new hardware.
