...
When building your custom kernel, you might want to apply patches or collections of patches (patchsets) to the Linux kernel.
...
In this instance, the sources are for a 6.18.37 kernel.
...
[source,console]
----
$ wget https://www.kernel.org/pub/linux/kernel/projects/rt/6.18/patch-6.18.37-rt6.patch.gz
$ gunzip patch-6.18.37-rt6.patch.gz
$ cat patch-6.18.37-rt6.patch | patch -p1
----
