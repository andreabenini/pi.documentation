...
This is available through device-tree in `/proc/device-tree/chosen/rpi-boardrev-ext` and for testing purposes this OTP value can be temporarily overridden by setting `board_rev_ext` in `config.txt`.
+
* Compute Module 4
...
This is available through device-tree in `/proc/device-tree/chosen/rpi-boardrev-ext`
...
If set, this is available through Device Tree in `/proc/device-tree/chosen/rpi-country-code`
...
This is available through device-tree in `/proc/device-tree/chosen/rpi-duid`.
