...
On the Raspberry Pi 4, 400 and Compute Module 4 there are four additional SPI buses: SPI3 to SPI6, each with two hardware chip selects. These extra SPI buses are available through alternate function assignments on certain GPIO pins. For more information, see the https://pip.raspberrypi.com/documents/RP-008248-DS[BCM2711 Arm peripherals] datasheet.
