...
USB 2.0 high speed devices, including USB 2.0 hubs, operate correctly when connected through a USB 3.0 hub.
...
Old webcams might be full-speed devices. Because these devices transfer a lot of data and incur additional software overhead, reliable operation is not guaranteed. As a workaround, try to use the camera at a lower resolution.
