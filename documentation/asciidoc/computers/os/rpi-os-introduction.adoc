...
Raspberry Pi OS is installed using Raspberry Pi Imager, available for Windows, Mac, and Linux. For instructions, see xref:../computers/getting-started.adoc#imager-install[Install using Imager]. You can also download a disk image (ready-to-use file) of Raspberry Pi OS directly from https://raspberrypi.com/software/operating-systems[our website] and then write it to an SD card to start using your Raspberry Pi.
...
=== Architecture
Raspberry Pi OS is available in both 64-bit and 32-bit versions. Choose the version that best matches your Raspberry Pi device's hardware:
