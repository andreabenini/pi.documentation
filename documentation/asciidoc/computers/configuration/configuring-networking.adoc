== Networking
Raspberry Pi OS provides flexible options for configuring network settings. This section summarises how to manage and customise the network configuration of your Raspberry Pi, including how to:
...
Your hostname isn't case sensitive and can only contain:
