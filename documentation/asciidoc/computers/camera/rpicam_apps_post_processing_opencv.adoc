...
NOTE: These stages require an OpenCV installation. You might need to xref:camera_software.adoc#build-libcamera-and-rpicam-apps[rebuild `rpicam-apps` with OpenCV support].
