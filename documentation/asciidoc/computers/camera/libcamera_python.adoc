...
The https://github.com/raspberrypi/picamera2[Picamera2 library] is a `rpicam`-based replacement for Picamera, which was a Python interface to the Raspberry Pi legacy camera stack. Picamera2 presents an easy-to-use Python API.
