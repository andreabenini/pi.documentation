...
* A xref:../accessories/sd-cards.adoc[microSD card] with at least 32 GB of storage and a way to connect it to another computer. You need a microSD if:
...
* A monitor or display (and appropriate power cable) to connect to your Raspberry Pi keyboard computer. For ease, we recommend the xref:../accessories/monitor.adoc[Raspberry Pi Monitor], which you can connect to power through your Raspberry Pi keyboard computer.
...
** Displays typically require their own power source. If you're using an official xref:../accessories/monitor.adoc[Raspberry Pi Monitor], you can connect your monitor to power through a USB cable connected to your Raspberry Pi keyboard computer. When you power on your keyboard computer, it then provides power to the Raspberry Pi Monitor.
* Optionally, speakers or headphones for audio output.
** You can output audio over micro HDMI, USB, or Bluetooth.
** The official xref:../accessories/monitor.adoc[Raspberry Pi Monitor] has two front-facing speakers. You can also connect speakers or headphones through the 3.5 mm audio jack at the back of the monitor.
