...
.Train motor, https://www.bricklink.com/v2/catalog/catalogitem.page?P=bb0896c01[Image from Bricklink]
...
.Active motor, https://www.bricklink.com/v2/catalog/catalogitem.page?P=bb0960c01[Image from Bricklink]
...
You can place the motor in a float position, meaning, there are no more constraints on it. This is a mode that you can use when using the motor as a tachometer, moving it and reading the position. If you still have constraints on the motors, you might not be able to move it.
