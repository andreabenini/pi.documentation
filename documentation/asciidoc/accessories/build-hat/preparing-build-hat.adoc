...
NOTE: Before starting to work with your Raspberry Pi Build HAT, xref:../computers/getting-started.adoc#desktop-setup[set up] your Raspberry Pi and xref:../computers/getting-started.adoc#install[install] the latest version of the operating system using https://www.raspberrypi.com/downloads/[Raspberry Pi Imager].
...
The following pins are used by the Build HAT itself; don't connect anything to them.
...
Connect an external power supply. We recommend the https://raspberrypi.com/products/build-hat-power-supply[official Raspberry Pi Build HAT power supply]. However, any reliable +8V±10% power supply capable of supplying 48 W through a DC 5521 centre positive barrel connector (5.5 mm × 2.1 mm × 11 mm) can power the Build HAT. You don't need to connect an additional USB power supply to the Raspberry Pi unless you are using a Keyboard-series device.
