...
The on-screen display (OSD) can show the following messages:
...
* reduce the display brightness and volume (you might have to connect your monitor to another power supply to access the settings)
