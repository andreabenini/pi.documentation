...
IMPORTANT: For optimal use of the memory available to the accelerator on the IMX500 sensor, add `--no-input-persistency` to the above commands. However, this disables input tensor generation that can be used for debugging purposes.
