...
NOTE: It is important that the power supply is connected to the Raspberry Pi and the keyboard is connected to the Raspberry Pi. If the power supply is connected to the keyboard, with the Raspberry Pi powered by the keyboard, the keyboard doesn't operate correctly.
